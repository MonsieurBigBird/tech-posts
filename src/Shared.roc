...
navbarHtml! = |activeNav|
    ...
    <div class="navbar bg-base-200 shadow-lg">
        <div class="navbar-start">
            <a href="/" class="btn btn-ghost hidden sm:flex text-sm sm:text-lg lg:text-xl font-mono">
