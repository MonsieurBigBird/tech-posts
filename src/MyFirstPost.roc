...
blogPostPageHtml! = |postSlug|
    when postSlug is
        "my-first-post" -> Post.renderPostPage!("My First Post - Blog", "blog", myFirstPostContentHtml)
        _ -> Post.renderPostPage!("Post Not Found - Blog", "blog", Post.notFoundPostContentHtml)
